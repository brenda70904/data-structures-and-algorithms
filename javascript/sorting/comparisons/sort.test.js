...
describe('Sorters', () => {
  ...
  it('run compareYear as expeceted', () => {
    expect(compareYear({ year: 1 },{ year: 0 })).toBeLessThan(0);
    expect(compareYear({ year: 0 },{ year: 1 })).toBeGreaterThan(0);
    expect(compareYear({ year: 1 },{ year: 1 })).toBe(0);
  });
});
